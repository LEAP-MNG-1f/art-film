...
export const MoviesHeader = () => {
  ...
  return (
    <div className="flex justify-between items-center px-4 py-2 bg-white shadow-md rounded-lg">
      <div className="text-2xl font-bold text-gray-800">Movie Editor</div>

      <div className="flex items-center w-[60%] bg-gray-100 border border-gray-300 pl-2 rounded-lg">
      ...
      <button
        className="px-6 py-2 rounded-lg font-semibold bg-orange-500 text-white hover:bg-orange-600 transition-all"
