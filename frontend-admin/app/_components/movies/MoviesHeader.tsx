...
export const MoviesHeader = () => {
  ...
  return (
    <div className="fixed w-full pr-[300px] bg-white">
      <div className="flex justify-between items-center px-4 py-2 border-b-2 border-t-2 pt-[50px]">
        <div className="text-2xl font-bold text-gray-800">Movie Editor</div>
        <div className="flex gap-5">
          <div className="flex items-center w-[50%] bg-gray-100 border border-gray-300 pl-2 rounded-lg">
