...
export const DreamerdayCreate = () => {
  ...
  return (
    <div className="m-10">
      <div className="flex flex-col bg-slate-200 rounded-2xl gap-5 shadow-xl mx-20">
        ...
        <div className="grid grid-cols-2 mb-10">
          ...
          >
            ...
            <div className="flex justify-end mt-10">
              <button
                type="submit"
                className="px-5 py-2 rounded-lg bg-orange-400 font-semibold hover:bg-slate-900 hover:text-white"
              >
                Шинээр нэмэх
              </button>
            </div>
