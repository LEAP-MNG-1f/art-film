  ...
  return (
    <div>
      ...
      <div className="flex justify-center">
        <div className="w-[1060px] py-10">
          <img
            className="w-[1060px] h-[502px] rounded-lg"
            ...
            <div className="w-[894px]">
              ...
              <div>
                <p className="text-black font-roboto text-[18px] font-normal leading-[32px]">
                  Тойм: Олон жилийн турш хоригдсон эр нэг л өдөр гар утас,
                  мөнгө, бас үнэтэй хувцастай суллагдах бөгөөд өөрийг нь ямар
                  учир шалтгаантайгаар, хэн барьж хорих болсныг олж мэдэхэд
                  түүнд тавхан өдрийн хугацаа бий.
                </p>
              </div>
